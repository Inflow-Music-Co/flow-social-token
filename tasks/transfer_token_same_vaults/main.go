...
func main() {
	...
	flow.TransactionFromFile("register_token_test").SignProposeAndPayAs("account").StringArgument("TestSymbol").UFix64Argument("1000.00").AccountArgument("first").RunPrintEventsFull()
