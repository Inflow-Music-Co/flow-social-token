...
func main() {
	...
	mintQuote := flow.ScriptFromFile("get_social_mint_quote").UFix64Argument("2000.0").StringArgument("TestSymbol_0x1cf0e2f2f715450").RunFailOnError()
	...
	// burn social Tokens
	BurnPrice := flow.ScriptFromFile("get_social_burn_quote").UFix64Argument("1300.00").StringArgument("TestSymbol_0x1cf0e2f2f715450").RunFailOnError()
	log.Printf(" ------ Social Mint Quote burn price ----- %s", BurnPrice)

	flow.TransactionFromFile("burn_social_token").SignProposeAndPayAs("second").StringArgument("TestSymbol_0x1cf0e2f2f715450").UFix64Argument("1300.00").RunPrintEventsFull()
